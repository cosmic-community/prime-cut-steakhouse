  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -top-2 -right-2 w-6 h-6 bg-neutral-600 hover:bg-neutral-700 text-white rounded-full flex items-center justify-center text-sm font-bold transition-colors duration-200 z-10"
