              ...
              {chef.metadata.image?.imgix_url && (
                <div className="w-full md:w-1/3 flex-shrink-0">
                  <div className="aspect-square overflow-hidden rounded-lg">
                    <img
                      src={`${chef.metadata.image.imgix_url}?w=400&h=400&fit=crop&auto=format,compress`}
              ...
              <div className="w-full md:w-2/3">
                ...
                {chef.metadata.experience_years && (
                  <p className="text-neutral-400 text-sm mb-4">
                    {chef.metadata.experience_years} years of experience
                  </p>
                )}
                ...
                {chef.metadata.specialties && (
                  <div>
                    ...
                    <p className="text-neutral-300 text-sm">
                      {chef.metadata.specialties.join(', ')}
                    </p>
                  </div>
                )}
              </div>
